...
def main() -> None:
    parser = argparse.ArgumentParser(); parser.add_argument("--config", type=Path, default=ROOT / "config.yaml"); parser.add_argument("--stage", choices=("smoke", "benchmark", "tune"), default="smoke"); args = parser.parse_args()
