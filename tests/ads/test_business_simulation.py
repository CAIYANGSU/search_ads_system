...
def test_raw_calibrated_and_search_value_paths_stay_independent() -> None:
    ...
    search = pd.DataFrame({"pCVR_clicked": [.1,.3], "predicted_conditional_value": [5., 10.], "conversion_value_eur": [0., 15.]})
    search_report, _ = simulate_search_conversion(search, config=SimulationConfig(candidates_per_auction=2, total_budget=10))
